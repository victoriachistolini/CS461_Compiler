...
Sys.time:
	...
	# DJS changed next line from "li $v0 18" to conform to MARS syscalls
	li $v0 30
	syscall
	# epilogue
	lw $ra 0($sp)
...
_label88:
	...
	# create a new bantam.Main object using the bantam.Main template and Object.clone
	la $a0 Main_template
	jal Object.clone
	move $a0 $v0
	# initialize the new bantam.Main object
	jal Main_init
	move $a0 $v0
	# call the main method within bantam.Main
	jal bantam.Main.main

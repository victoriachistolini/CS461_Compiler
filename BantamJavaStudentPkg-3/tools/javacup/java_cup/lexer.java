...
/** This class implements a small scanner (aka lexical analyzer or bantam.lexer) for
 ...
 *    "bantam.parser"      PARSER                "terminal"    TERMINAL
 *    "non"         NON                   "init"        INIT 
 *    "scan"        SCAN                  "with"        WITH
 ...
 *  JavaCup from bantam.parser.cup.<p>
 * 
...
public class lexer {
  ...
  public static void init() throws java.io.IOException
    {
      ...
      keywords.put("bantam.parser",     new Integer(sym.PARSER));
   ...
   *  bantam.parser, this can be changed to call debug_next_token() which prints

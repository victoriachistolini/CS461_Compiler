...
/** CUP v0.10k generated bantam.parser.
...
public class parser extends java_cup.runtime.lr_parser {
 ...
 bantam.lexer.init();
  ...
  public java_cup.runtime.Symbol scan()
    throws java.lang.Exception
    {
 return bantam.lexer.next_token();
    }
  ...
  public void report_fatal_error(
    ...
    {
      done_parsing();
      bantam.lexer.emit_error(message);
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		bantam.lexer.emit_error("Illegal use of reserved word");
		RESULT="ILLEGAL";
	  ...
	  if (symbols.get(non_term_id) != null)
	    {
	      /* issue a message */
	      bantam.lexer.emit_error( "java_cup.runtime.Symbol \"" + non_term_id +
	  ...
	  if (symbols.get(term_id) != null)
	    {
	      /* issue a message */
	      bantam.lexer.emit_error("java_cup.runtime.Symbol \"" + term_id +
			   "\" has already been declared");
	    }
	  else
	    {
	  ...
	  if (symb == null)
	    {
	      if (bantam.lexer.error_count == 0)
	        bantam.lexer.emit_error("java_cup.runtime.Symbol \"" + symid +
	  ...
	  new_rhs();
          ...
          case 61: // NT$13 ::= 
            {
              Object RESULT = null;
 bantam.lexer.emit_error("Syntax Error");
	  ...
	  if (lhs_nt == null)
	    {
	      if (bantam.lexer.error_count == 0)
	        bantam.lexer.emit_error("LHS non terminal \"" + lhs_id +
			       "\" has not been declared");
	    }
	  ...
	  if (nt == null)
	    {
	      bantam.lexer.emit_error( "Start non terminal \"" + start_name +
	  		         "\" has not been declared");
	    }
          else
	    {
	  ...
	  if (symbols.get(sym) == null)
	    {
	      /* issue a message */
	      bantam.lexer.emit_error("Terminal \"" + sym +
			   "\" has not been declared");
	    }
          RESULT = sym;
	  ...
	  if (emit.scan_code!=null)
	    bantam.lexer.emit_error("Redundant scan code (skipping)");
	  ...
	  if (emit.init_code!=null)
	    bantam.lexer.emit_error("Redundant init code (skipping)");
	  else /* save the user code */
	  ...
	  if (emit.parser_code!=null)
	    bantam.lexer.emit_error("Redundant bantam.parser code (skipping)");
	  ...
	  if (emit.action_code!=null)
	    bantam.lexer.emit_error("Redundant action code (skipping)");
	  else /* save the user included code string */

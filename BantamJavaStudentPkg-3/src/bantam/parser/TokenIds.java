...
public class TokenIds {
  ...
  // key words, including primative data types
  ...
  public static final int BOOLEAN_FALSE = 43;
  public static final int BOOLEAN_TRUE = 44;
  ...
  // identifiers: int and names (DO!)
  public static final int INT_CONST = 40;
  public static final int ID = 39;

  // ERRORS:, white space and comments

 ...
 *  configuration that the bantam.parser may be in.  For example, an item of the
 *  form: <pre>
 *    [A ::= B * C d E  , {a,b,c}]
 *  </pre>
 *  indicates that the bantam.parser is in the middle of parsing the production <pre>
 *    A ::= B C d E
 *  </pre>

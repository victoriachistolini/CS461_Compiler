...
/** 
 * This class handles emitting generated code for the resulting bantam.parser.
 ...
 *          that were embedded in the bantam.parser specification.
 *   <dt> bantam.parser class
 *   <dd>   the specialized bantam.parser class consisting primarily of some user
 *          supplied general and initialization code, and the parse tables.
 *   </dl><p>
 *
 *  Three parse tables are created as part of the bantam.parser class:
 *    <dl>
 *    <dt> production table
...
/* Major externally callable routines here include:
     ...
     bantam.parser                - emit the bantam.parser class
   ...
   parser_class_name       - name of the class for the resulting bantam.parser.
   ...
   parser_code             - user supplied declarations and other code to be 
			     placed in bantam.parser class.
   init_code               - user supplied code to be executed as the bantam.parser
...
public class emit {
  ...
  /** Name of the generated bantam.parser class. */
  public static String parser_class_name = "bantam.parser";
  ...
  /** User declarations for direct inclusion in bantam.parser class. */
  public static String parser_code = null;

  /*. . . . . . . . . . . . . . . . . . . . . . . . . . . . . .*/

  /** User code for user_init() which is called during bantam.parser initialization. */
  ...
  /** Time to produce bantam.parser class. */
  ...
  public static void symbols(PrintWriter out, 
      ...
      for (Enumeration e = terminal.all(); e.hasMoreElements(); )
	{
      ...
      /* do the non terminals if they want them (bantam.parser doesn't need them) */
      if (emit_non_terms)
	{
          out.println();
  ...
  protected static void emit_action_code(PrintWriter out, production start_prod)
      ...
      if (action_code != null)
	{
      ...
      /* field for bantam.parser object */
      out.println("  private final "+parser_class_name+" bantam.parser;");

      /* constructor */
      out.println();
      out.println("  /** Constructor */");
      out.println("  " + pre("actions") + "("+parser_class_name+" bantam.parser) {");
      out.println("    this.bantam.parser = bantam.parser;");
      out.println("  }");
      ...
      out.println("    java_cup.runtime.lr_parser " + pre("bantam.parser,"));
      out.println("    java.bantam.util.Stack            " + pre("stack,"));
      ...
      for (Enumeration p = production.all(); p.hasMoreElements(); )
	{
	  ...
	  if (prod == start_prod)
	    {
	      out.println("          /* ACCEPT */");
	      out.println("          " + pre("bantam.parser") + ".done_parsing();");
	    }
  ...
  /** Emit the bantam.parser subclass with embedded tables.
   * @param out             stream to produce output on.
  ...
  public static void parser(
	...
	out.println("import " + import_list.elementAt(i) + ";");
      ...
      /* class header */
      out.println();
      out.println("/** "+version.title_str+" generated bantam.parser.");
      ...
      out.println("    java_cup.runtime.lr_parser bantam.parser,");
      out.println("    java.bantam.util.Stack            stack,");
      out.println("    int                        top)");
      out.println("    throws java.lang.Exception");
      out.println("  {");
      out.println("    /* call code in generated class */");
      out.println("    return action_obj." + pre("do_action(") +
                  "act_num, bantam.parser, stack, top);");
      out.println("  }");
      out.println("");


      /* method to tell the bantam.parser about the start state */
